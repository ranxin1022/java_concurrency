...
import multi_thread.Chapter4.useConditionWaitNotifyOk.ThreadA;
...
public class MyService
{
    ...
    public void signalAll()
    {
        ...
        {
            lock.lock();
            System.out.println(" signalAll 时间为 " + System.currentTimeMillis() + " ThreadName = " + ThreadA.currentThread().getName());
            condition.signalAll();
        }
        finally
        {
